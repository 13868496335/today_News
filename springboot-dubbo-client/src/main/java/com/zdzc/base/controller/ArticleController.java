...
public class ArticleController {
    ...
    public ModelAndView getArticles(HttpSession session){
        ...
        List article=articleService.getUserAllArticles(t_user_account);
    ...
    public ModelAndView xw_getArticles(){
        ModelAndView mv=new ModelAndView();
        List article=articleService.getAllArticles();
        mv.addObject("allarticle",article);
    ...
    public ModelAndView deleteArticle(String t_article_id){
        ModelAndView mv=new ModelAndView();
        if (articleService.deleteById(t_article_id)){
            List article=articleService.getAllArticles();
            mv.addObject("allarticle",article);
            String success="删除成功！";
    ...
    public ModelAndView updateArticle(String t_article_id){
        ModelAndView mv=new ModelAndView();
        List<Map<String,Object>> article=articleService.queryArticleById(t_article_id);
    ...
    public ModelAndView saveArticle(String t_article_title_1,
        ...
        String t_user_account=session.getAttribute("t_user").toString();
        ModelAndView mv=new ModelAndView();
        articleService.insertArticle(t_article_title_1,t_article_title_2,t_article_title_3,t_article_source,t_article_author,t_article_create_date,t_article_img1,t_article_img2,t_article_img3,t_article_img4,t_article_img5,t_article_document,t_article_classification,t_user_account);
        List article=articleService.getAllArticles();
        mv.addObject("allarticle",article);
    ...
    public ModelAndView xwsaveArticle(String t_article_title_1,
        ...
        ModelAndView mv=new ModelAndView();
        articleService.xwinsertArticle(t_article_title_1,t_article_title_2,t_article_title_3,t_article_source,t_article_author,t_article_create_date,t_article_img1,t_article_img2,t_article_img3,t_article_img4,t_article_img5,t_article_document,t_article_classification,t_classification_code);
        List article=articleService.getAllArticles();
        mv.addObject("allarticle",article);
        mv.setViewName("/app2/xw_article.html");
        return mv;
